#!/usr/bin/env python3
"""
Example Usage of Government Gazette Structure Analyzer

This script demonstrates how to use the GazetteStructureAnalyzer
...
# Import the analyzer directly since we're in the same directory
from gazette_structure_analyzer import GazetteStructureAnalyzer

def main():
    """Example usage of the gazette structure analyzer"""
    ...
    try:
        ...
        print("🚀 Initializing Gazette Structure Analyzer...")
        analyzer = GazetteStructureAnalyzer()
        ...
        print("1. Make sure VISION_AGENT_API_KEY environment variable is set")
